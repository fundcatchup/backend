...
# phone="+9199999$(tr -cd '[:digit:]' < /dev/urandom | fold -w 5 | head -n 1)"
phone="+919836250711"
...
@test "register: new user" {
    ...
    ${run_cmd} curl -s \
        ...
        -d "{\"traits.email\": \"$email\", \"password\": \"$password\", \"traits.fullName\": \"$fullName\", \"traits.phone\": \"$phone\", \"method\": \"password\"}" \
